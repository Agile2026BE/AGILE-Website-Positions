...
export default function SiteFooter() {
  const[clientOpen,setClientOpen]=useState(false);const[sending,setSending]=useState(false);const[status,setStatus]=useState("");const[inquirySubject,setInquirySubject]=useState("hiring");const[clientMessage,setClientMessage]=useState(inquiryMessages.hiring);
  function openClientSupport(){setStatus("");setInquirySubject("hiring");setClientMessage(inquiryMessages.hiring);setClientOpen(true);}
