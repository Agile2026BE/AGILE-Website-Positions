  ...
  return (
    <footer className={`site-footer ${styles.footer}`}>
      <div className={`container footer-grid ${styles.grid}`}>
        <div>
          <div className={`footer-brand ${styles.brand}`}>AGILE</div>
          <p>
      ...
      <div className={`footer-bottom ${styles.bottom}`}>
        <div className={`container footer-bottom-inner ${styles.bottomInner}`}>
