    ...
    <section className={styles.section} id="market-insights" aria-labelledby="market-insights-title">
      <div className={styles.panel}>
        ...
        <form className={styles.form} onSubmit={handleSubmit}>
          ...
          <label>Experience Level<select name="experience" defaultValue=""><option value="">Choose experience</option><option>Early Career</option><option>Intermediate</option><option>Senior</option><option>Leadership</option></select></label>
