    ...
    <main className={styles.page}>
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.actionGrid}>
            <a href="https://careers.agileconsultingsolutions.com/#positions" className={styles.primary}>Explore Opportunities</a>
      ...
      <section className={styles.intro} id="professionals">
        ...
        <div className={styles.introGrid}>
          ...
          <div><p>AGILE works directly with hiring leadership across Architecture, Engineering, Construction, Commissioning, and Owner’s Representation. We help experienced Professionals understand the opportunity before making a move.</p><a href="https://careers.agileconsultingsolutions.com" className={styles.textLink}>Search current positions →</a></div>
        </div>
      </section>
      ...
      <section className={styles.finalCta} id="contact"><p className={styles.sectionLabel}>YOUR NEXT MOVE</p><h2>Ready when you are.</h2><p>Explore current opportunities or start a confidential conversation with AGILE.</p><div className={styles.heroActions}><a href="https://careers.agileconsultingsolutions.com/#positions" className={styles.primary}>Search Careers</a><a href="mailto:careers@agileconsultingsolutions.com" className={styles.outlineDark}>Start a Conversation</a></div></section>
      <SiteFooter />
    </main>
  );
}
