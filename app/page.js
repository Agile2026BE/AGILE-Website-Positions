    ...
    <main className={styles.page}>
      ...
      <section className={styles.aboutSection} id="about-agile" aria-labelledby="about-agile-title">
        <div className={styles.aboutInner}>
          ...
          <p className={styles.aboutCopy}>We recruit across the following markets: New York · New Jersey · Pennsylvania · Massachusetts · Connecticut · North&nbsp;Carolina · Florida · Colorado · California. Our client relationships include ENR Top 100 and Top 500 Design Firms, nationally recognized multidisciplinary consulting firms, notable mid-size and regional consultants, and Best Places to Work award winners.</p>
