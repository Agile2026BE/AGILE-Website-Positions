...
const titleLine = colored(title, { size: "15px", weight: 700, color: "#152033", margin: "0 0 5px" });
const detail = detailLine ? colored(detailLine, { size: "13px", weight: 400, color: "#5d6b78", margin: "0 0 5px" }) : "";
const salaryLine = salary ? colored(salary, { size: "16px", weight: 800, color: "#067647", margin: "0 0 5px" }) : "";
