...
export function positionShareHtml(job) {
  ...
  const colored = (text, { size, weight = 400, color, letterSpacing, margin = "0 0 2px" }) => {
    const innerStyle = `font-family:Arial,Helvetica,sans-serif;font-size:${size};font-weight:${weight};color:${color};`;
    return `<div style="font-family:Arial,Helvetica,sans-serif;font-size:${size};font-weight:${weight};color:${color};${letterSpacing ? `letter-spacing:${letterSpacing};` : ""}line-height:1.3;margin:${margin}"><span style="${innerStyle}"><font style="${innerStyle}" color="${color}">${text}</font></span></div>`;
  };
  ...
  const linkStyle = "font-family:Arial,Helvetica,sans-serif;font-size:9.5pt;font-weight:600;color:#1476a8;text-decoration:underline;";
  ...
  const similarStyle = "font-family:Arial,Helvetica,sans-serif;font-size:8.5pt;font-weight:400;color:#5a7185;text-decoration:underline;";
