...
const titleLine = colored(title, { size: "10px", weight: 600, color: "#173958" });
...
const similarSizeWeight = "font-size:10px;font-weight:700;";
const similarColor = "#1476a8";
const similarLink = `<div style="margin:0"><a href="${url}#similar-positions" style="font-family:Arial,Helvetica,sans-serif;font-size:10px;font-weight:700;color:${similarColor};text-decoration:underline"><span style="${similarSizeWeight}"><span style="color:${similarColor}"><font color="${similarColor}">Similar Positions</font></span></span></a></div>`;
