...
// Copies ONLY the short, plain-text summary — safe to paste anywhere,
// including apps (like iMessage/Mac Messages) that were found to silently
// convert any rich/HTML clipboard content into a longer, uglier
// "Label (full-url-with-www)" form instead of using the plain text written
// for that purpose. Used by the per-card "Copy Link" button, which should
// do exactly what it says: copy a link, not a formatted card.
