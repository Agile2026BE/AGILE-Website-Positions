...
// A candidate selects the specific experience band that describes them, and
// only postings whose own required-experience range overlaps that band are
// shown — e.g. selecting "11–15 years" shows postings requiring 11–15 years,
// not postings capped at 1–2 or 3–5 years (those don't overlap 11–15 at all).
// A posting with an open-ended requirement ("10+ years", "Minimum 10 years")
// has no stated upper bound, so it still matches any band at or above its
// minimum — a "10+ years" posting reasonably matches an "11–15 years" search.
