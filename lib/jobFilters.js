...
const workplaceGroup = (value) => {
  ...
  if (text.includes("hybrid") || /\b[1-4]\s*\/\s*[1-4]\b/.test(text) || text.includes("50/50")) return "hybrid";
...
const disciplineMatches = (job, selected) => {
  ...
  const aliases = {
    "mechanical hvac": ["hvac", "mechanical engineer", "mechanical engineering"],
    "mechanical plumbing and fire protection": ["plumbing", "fire protection", "fire suppression", "mechanical plumbing"],
